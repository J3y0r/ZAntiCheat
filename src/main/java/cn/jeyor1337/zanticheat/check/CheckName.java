...
public enum CheckName {
    ...
    AIRJUMP_A(CheckType.MOVEMENT, "AirJump_A", "MidAirJump"),
    ...
    KILLAURA_E(CheckType.COMBAT, "KillAura_E", "Rotation"),
    FAKELAG_A(CheckType.COMBAT, "FakeLag_A", "Lagrange"),
    ...
    BLOCKPZACE_A(CheckType.INTERACTION, "BlockPlace_A", "Rotation"),
    BLOCKPZACE_B(CheckType.INTERACTION, "BlockPlace_B", "Reach"),
    ...
    BADPACKETS_D(CheckType.PACKET, "BadPackets_D", "SetCreativeSlot"),
    BADPACKETS_E(CheckType.PACKET, "BadPackets_E", "MultiAttack"),
    BADPACKETS_F(CheckType.PACKET, "BadPackets_F", "InvalidSlotSwitch"),
