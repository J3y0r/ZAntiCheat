...
public class NoFallA extends MovementCheck implements Listener {
    ...
    public void onAsyncMovement(ZACAsyncPlayerMoveEvent event) {
        ...
        if (currentTime - zacPlayer.joinTime < 5000) {
            buffer.put("fallEvents", 0);
            buffer.put("fallStartLocation", null);
            return;
        }
        ...
        Scheduler.runTask(true, () -> {
            ...
            callViolationEventIfRepeat(player, zacPlayer, event, buffer, 1500);
        });
    }
    ...
    @EventHandler
    public void scaffoldBlockBreak(ZACAsyncPlayerBreakBlockEvent event) {
