package cn.jeyor1337.zanticheat.util.config.placeholder;
...
public class PlaceholderConvertor {
    ...
    public static String swapAll(String text, CheckSetting checkSetting, Player player, ZACPlayer zacPlayer) {
        ...
        text = text.replaceAll("%prefix%", ConfigManager.Config.Messages.prefix)
                ...
                .replaceAll("%vio%", String.valueOf(zacPlayer.violations.getViolations(checkSetting.name)))
