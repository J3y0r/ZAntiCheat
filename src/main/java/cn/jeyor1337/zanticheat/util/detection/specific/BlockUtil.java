package cn.jeyor1337.zanticheat.util.detection.specific;
...
public class BlockUtil {
    ...
    public static Set<Block> getWithinBlocks(Entity player, Location location) {
        if (VerIdentifier.getVersion().isNewerThan(ZACVersion.V1_8) || FoliaUtil.isFolia() || Bukkit.isPrimaryThread())
