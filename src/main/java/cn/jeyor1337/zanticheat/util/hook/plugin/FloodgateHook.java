package cn.jeyor1337.zanticheat.util.hook.plugin;
...
public class FloodgateHook {
    ...
    public static boolean isBedrockPlayer(Player player) {
        return CooldownUtil.isBedrockPlayer(ZACPlayer.getZacPlayer(player).cooldown, player);
    }

    @SecureAsync
    public static boolean isBedrockPlayer(Player player, boolean async) {
        return CooldownUtil.isBedrockPlayer(ZACPlayer.getZacPlayer(player).cooldown, player, async);
    }
